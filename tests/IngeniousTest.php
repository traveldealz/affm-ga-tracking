...
class IngeniousTest extends TestCase {
	...
	public function test_set_subid() {
        ...
        $this->assertEquals( 'https://atlas.r.akipam.com/ts/i5036400/tsc?typ=r&amc=con.blbn.456151.471983.CRT2-TEl0AA&tst=!!TIMESTAMP!!&smc3=test123', $url );
	}
	...
	public function test_set_subid_starcar() {
		...
		$url = $Subid->add_subid('test123')->get();
        $this->assertEquals( 'https://janus.r.jakuli.com/ts/i5533913/tsc?typ=r&amc=con.blbn.456151.471983.CRTsBS2zilS&tst=!!TIMESTAMP!!&smc3=test123', $url );
	}
